...
sealed class BottomNavItem(val title: String, val iconId: Int, val route: String) {
    ...
    data object NoteItem: BottomNavItem("Note", R.drawable.nav_note_item_icon, "route2")
    data object AboutItem: BottomNavItem("About", R.drawable.fl_add_icon, "route3")
    data object SettingsItem: BottomNavItem("Settings", R.drawable.nav_setting_item_icon, "route4")
}